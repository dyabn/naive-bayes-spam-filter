...
INITIAL_TRAINING_SAMPLES = [
    ...
    ("请点击链接下载实验报告。", 0, "curated_training"),
    ("课程资料限时开放，请及时下载。", 0, "curated_training"),
    ("请领取本次培训资料。", 0, "curated_training"),
    ("请点击链接进入在线课堂。", 0, "curated_training"),
    ("实验奖励名单已经公布，请查看通知。", 0, "curated_training"),
    ("请领取本次活动的学习资料。", 0, "curated_training"),
    ("请领取活动纪念礼品。", 0, "curated_training"),
    ("请点击链接报名参加社团活动。", 0, "curated_training"),
    ("限时开放学习资料，请点击链接查看。", 0, "curated_training"),
    ("请领取会议纪念礼品。", 0, "curated_training"),
    ("学习资料链接已经发布，请及时查看。", 0, "curated_training"),
    ("本次课程奖励积分已经更新，请查看通知。", 0, "curated_training"),
    ("促销活动开始，请立即点击链接。", 1, "curated_training"),
    ("限时促销礼品，请点击链接领取。", 1, "curated_training"),
    ("免费现金奖励等待领取。", 1, "curated_training"),
    ("点击链接领取现金。", 1, "curated_training"),
    ("领取免费礼品。", 1, "curated_training"),
    ("限时领取奖励。", 1, "curated_training"),
    ("请立即点击链接领取奖励。", 1, "curated_training"),
    ("限时活动，请领取礼品。", 1, "curated_training"),
    ("促销礼品等待领取，请点击链接。", 1, "curated_training"),
    ("现金奖励限时开放，请点击链接领取。", 1, "curated_training"),
    ("免费礼品等待领取，请立即点击。", 1, "curated_training"),
    ("恭喜获得现金奖励，请点击链接领取。", 1, "curated_training"),
    ("明天上午进行课程答疑，请按时参加。", 0, "curated_training"),
    ("项目小组今晚讨论报告结构。", 0, "curated_training"),
    ("请查看老师发布的实验安排。", 0, "curated_training"),
    ("本周课程作业已经布置，请按时完成。", 0, "curated_training"),
    ("图书馆座位预约已经成功。", 0, "curated_training"),
    ("班级通知已经发布，请及时查看。", 0, "curated_training"),
    ("促销活动开始，请立即查看。", 1, "curated_training"),
    ("促销信息提醒，请马上参与。", 1, "curated_training"),
    ("限时促销活动，请马上查看。", 1, "curated_training"),
    ("促销奖励正在发放，请立即点击。", 1, "curated_training"),
    ("促销礼品正在派送，请马上领取。", 1, "curated_training"),
    ("促销现金活动开启，请立即参与。", 1, "curated_training"),
]
